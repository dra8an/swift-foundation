...
internal final class _CalendarJapanese: _CalendarProtocol, @unchecked Sendable {
    ...
    // Local research divergence, not for upstream: the PR stores this as InlineArray<5, ...>, which needs the macOS 26 runtime; a plain array is semantically identical.
